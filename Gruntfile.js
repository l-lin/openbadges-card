...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        ngtemplates: {
            main: {
                options: {
                    module: 'openbadgesCard',
                    base: '<%= yeoman.src %>'
                },
                src: '<%= yeoman.src %>/*.html',
                dest: '<%= yeoman.build %>/openbadges-card.template.js'
            }
        },
        concat: {
            options: {
            ...
            bannerCSS: {
                ...
                dest: '<%= yeoman.dist %>/openbadges-card.css'
            }
        },
        cssmin: {
            options: {
            ...
            dist: {
                files: {
                    '<%= yeoman.dist %>/openbadges-card.min.css': [
                        '<%= yeoman.src %>/*.css'
                    ]
                }
            }
        ...
        uglify: {
            ...
            dist: {
                files: {
                    '<%= yeoman.dist %>/openbadges-card.min.js': [
